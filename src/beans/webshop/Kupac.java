...
public class Kupac extends Korisnik {
    ...
    public Kupac(KorisnikInfo k){
        super(k);
    }


    public Kupac(String username, String password, String ime, String prezime, Pol pol, Date datumRodjenja, Uloga uloga, int brojBodova, ArrayList<Karta> karte, TipKupca tip) {
    ...
    public Kupac(String username, String password, String ime, String prezime, Pol pol, Date datumRodjenja, Uloga uloga, int brojBodova) {
        super(username, password, ime, prezime, pol, datumRodjenja, uloga);
        this.brojBodova = brojBodova;
        this.karte = new ArrayList<>();
    }
